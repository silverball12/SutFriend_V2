...
public class ListUserAdapter extends RecyclerView.Adapter<ListUserAdapter.ListUserViewHolder>{
    ...
    public ListUserAdapter(Context context, ArrayList<String> nameStringArrayList, ArrayList<String> urlAvataStringArrayList) {
    ...
    public void onBindViewHolder(ListUserViewHolder holder, int position) {
        ...
        Picasso.get().load(urlAvataString).resize(100,100).into(holder.circleImageView);
